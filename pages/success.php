<?php 
$con=mysqli_connect("localhost","root","","internshaladb") or die(mysqli_error($con));
session_start();
...
<div class="container" style="margin-top: 80px;">
	...
	<center><p>Thank You for ordering from E-store. Your order shall be delivered<br>to you shortly. <br><br><br>Order some more items <a href="index.php"> here</a>.</p></center>
    </div>
    </div>
</div>
