...
<div class="row" >
	...
	<div class="row-style-login-page-pannel">
		<div class="col-sm-9 col-xs-12">
			...
			<img src="images\callcenter1.jpg">
	...
	<div class="row-style-login-page-pannel" >
		<div class="col-sm-6 col-xs-12" >
			...
			<form method="post"  action="cont.php">
				...
				<div class="form-group">
                                    Email Id:<input type="email" class="form-control" placeholder="Email-id" name="email" >
				</div>
			...
			<p>E store,<br>R2 stret, Nehru Nagar,<br>New Delhi, India<br>Phone:9988776655<br>Fax: (000) 22-444-111<br>Email:abcd@mycompany.com<br>Follow on:Facebook, Instagram<br></p>
			</div>
